...
def AppCreate(EntityName):
    execCmd("cd " + BASE_DIR+ "\\apps" + "&& django-admin startapp " + EntityName)
    shutil.rmtree(BASE_DIR+ "\\apps\\" + EntityName +"\\migrations")
    os.remove(BASE_DIR+ "\\apps\\" + EntityName +"\\admin.py")
    os.remove(BASE_DIR+ "\\apps\\" + EntityName +"\\tests.py")
    # os.remove(BASE_DIR+ "\\apps\\" + EntityName +"\\views.py")
    #os.remove(BASE_DIR+ "\\apps\\" + EntityName +"\\__init__.py")
...
def ModelCreate(tablename):
    ...
    fp = open(BASE_DIR + '\\apps\\' + EntityName + '\\models.py' , "w",encoding='utf8')
